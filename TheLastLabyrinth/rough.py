...
class Ghost:
    ...
    def heuristic_blinky(self, a, b):
        ...
        return abs(a[1] - b[0]) + abs(a[0] - b[1])         #######reduced power
    ...
    def move_blinky(self):
        ...
        adjacency_dict = self.createAdjacencyDict()  # Get adjacency dictionary
    ...
    def move_inky(self):
        ...
        next_move = None
        min_distance = float('inf')  
        #loop through next possible states
        for neighbor in adjacent_positions:
...
def draw_misc():
    ...
    if (time.time()-st1<=25):
        time_text = font.render(str(int(25-(time.time()-st1)))+' Seconds until inky arrives' ,True,'blue')
