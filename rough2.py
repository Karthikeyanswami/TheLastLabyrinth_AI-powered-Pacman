...
inky_yc= 26#31
inky_direction=0
TEMPERATURE = 100  # initial temp
COOLING_RATE = 0.5  # Cooling rate
###as temp decreases, the moves become better
...
class Ghost:
    ...
    def move_inky(self):      #simulated annealing
        global TEMPERATURE  
        ...
        while TEMPERATURE > 1:
            ...
            if next_distance < best_distance:
                #if better move, accept it
                best_move, best_distance = next_move, next_distance
            else:
                #if worse move, accept withe some probability
